...
export class Backend implements backendInterface {
    ...
    async getGlobalTop10(): Promise<Array<ScoreEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getGlobalTop10();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getTop10ByAgeGroup(arg0: string): Promise<Array<ScoreEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTop10ByAgeGroup(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitScore(arg0: ScoreEntryInput): Promise<void> {
        if (this.processError) {
            try {
